            ...
            <div class="card-body">
                <form method="POST" action="{{ route('Kategori.store') }}" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" name="name" required="required" placeholder="Masukan Name ...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-block btn-success btn-flat form-control">CREATE</button>
                    </div>
                    <div class="form-group">
